...
class CreateDedicationProposalSchedulesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dedication_proposal_schedules', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('dedication_proposal_schedules');
    }
}
