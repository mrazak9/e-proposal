                            ...
                            <table class="table table-bordered table-hover" id="tab_logic">
                                ...
                                <tbody>
                                    <tr id='penerimaan0'>
                                        ...
                                        <td>
                                            <textarea name='penerimaan_name[0]' class="form-control" cols="20" rows="3" required></textarea>
                                        </td>
                                        <td>
                                ...
                                $(document).ready(function() {
                                    ...
                                    $("#add_row").click(function() {
                                        $('#penerimaan' + i).html("<td>" + (i + 1) + "</td><td><textarea name='penerimaan_name[" + i +
                                            "]' type='text' class='form-control' cols='20' rows='3' required></textarea></td><td><select class='form-control' name='penerimaan_type_anggaran_id[" + i +"]' required><option selected disabled>== Pilih Tipe Anggaran ==</option>@foreach ($type_anggaran as $value => $key)<option value='{{ $key }}'>{{ $value }}</option>@endforeach</select></td><td><input name='penerimaan_qty[" +
                                            i +
