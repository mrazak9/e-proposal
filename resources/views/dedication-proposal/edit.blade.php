...
@section('template_title')
    Perbarui Pengajuan Pengabdian | {{ $dedicationProposal->title ?? '' }}
@endsection

@section('content')
    <section class="content container-fluid">
        <form method="POST" action="{{ route('admin.dedication-proposals.update', $dedicationProposal->id) }}" role="form"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="member" role="tabpanel"
                                            ...
                                            @include('dedication-proposal.edit-dedication.anggota')
                                        </div>
                                        <div class="tab-pane" id="detail" role="tabpanel" aria-labelledby="detail-tab">
                                            @include('dedication-proposal.edit-dedication.detail')
                                        </div>
                                        <div class="tab-pane" id="schedule" role="tabpanel" aria-labelledby="schedule-tab">
                                            @include('dedication-proposal.edit-dedication.schedule')
                                        </div>
                                    </div>
                                </div>
                            </div>
