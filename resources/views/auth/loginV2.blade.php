...
<body class="bg-gray-200">
    <main class="main-content  mt-0">
        <div class="page-header align-items-start min-vh-100"
            style="background-image: url('https://images.unsplash.com/photo-1519389950473-47ba0277781c?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80');">
                        ...
                        <div class="card z-index-0 fadeIn3 fadeInBottom">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                                    <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">e-Proposal - IDE
                                        LPKIA</h4>
                                    <div class="row mt-3">
                                        <div class="col-12 text-center me-auto">
                                            <a class="btn btn-outlined px-3 text-white" href="{{ url('auth/google') }}">
                                                <i class="fa fa-google text-white text-lg"> </i> sign in with Google
                                            </a>
                                        </div>
                                    </div>
                                </div>
